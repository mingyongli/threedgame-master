...
public class XRecyclerView extends RecyclerView {
    ...
    private void init() {
        ...
        mFootView = footView;
        mFootView.setMinimumHeight((int)getResources().getDimension(R.dimen.foot_min_height));//临时 测试最小高度
        mFootView.setVisibility(GONE);
        ////临时 设置底部状态文字
//        setFootViewText(getResources().getString(R.string.listview_loading),getResources().getString(R.string.nomore_loading));
    }

    public void setFootViewText(String loading, String noMore,String loadingError) {
        if(mFootView instanceof LoadingMoreFooter){
            ((LoadingMoreFooter) mFootView).setLoadingHint(loading);
            ((LoadingMoreFooter) mFootView).setNoMoreHint(noMore);
            ((LoadingMoreFooter) mFootView).setLoadingErrorHint(loadingError);
        }
    }
