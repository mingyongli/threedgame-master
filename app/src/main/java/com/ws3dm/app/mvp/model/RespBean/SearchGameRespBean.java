 ...
 **/
public class SearchGameRespBean extends BaseRespBean<SearchGameRespBean.DataBean>{
	...
	public static class DataBean {
		...
		private int total;
		private List<SearchGamebean> list;
		...
		public List<SearchGamebean> getList() {
			return list;
		}

		public void setList(List<SearchGamebean> list) {
			this.list = list;
		}
