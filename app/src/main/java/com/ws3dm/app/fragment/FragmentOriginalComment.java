...
import com.ws3dm.app.databinding.FgOriginalCommentBinding;
...
public class FragmentOriginalComment extends BaseFragment {
	private FgOriginalCommentBinding mBinding;
...
//		AppCompatActivity activity = (AppCompatActivity) getActivity();
		...
		mBinding = DataBindingUtil.inflate(inflater, R.layout.fg_original_comment, container, false);
	...
	public void initView() {
		...
		arcUrl=originalBean.getArcurl();
		if(originalBean.getShowtype()==7)//6评测7原创
			mBinding.txtTitle.setText("3DM·原创");
		else
			mBinding.txtTitle.setText("3DM·评测");
		mPage = 1;
		isFirst = true;
