...
import com.ws3dm.app.databinding.FgNewsResearchBinding;
 ...
 **/
public class FragmentNewsResearch extends BaseFragment {	
	private FgNewsResearchBinding mBinding;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		mBinding = DataBindingUtil.inflate(inflater, R.layout.fg_news_research, container, false);
...
//		mBinding.recyclerview.addItemDecoration(mListV3DividerItemDecoration);
		...
		mAdapter = new CommonRecyclerAdapter<NewsBean>(mContext, R.layout.adapter_news_research) {
			@Override
...
//				holder.setImageByUrl(R.id.img_head,item.getUser().avatarstr);   
				...
				holder.setImageByUrl(R.id.img_news,item.getLitpic());
			}
		};
...
//        mForumPresenter.getForumRank(obj.toString());
		...
		Call<NewsListRespBean> call = service.getGLpage(body);
