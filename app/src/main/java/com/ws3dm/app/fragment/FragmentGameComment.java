...
import com.ws3dm.app.databinding.FgGameCommentBinding;
 ...
 **/
public class FragmentGameComment extends BaseFragment {
	private FgGameCommentBinding mBinding;
...
//		AppCompatActivity activity = (AppCompatActivity) getActivity();
		...
		mBinding = DataBindingUtil.inflate(inflater, R.layout.fg_game_comment, container, false);
	...
	public void initView() {
		...
		gameBean = (GameBean) getArguments().getSerializable("gameBean");
		arcUrl=gameBean.getArcurl();
		mPage = 1;
		isFirst = true;
...
//							holder.setImageResource(R.id.imgBad,R.drawable.click_bad_grey);
	...
	public void submitReport(int id) {//提交举报内容
		...
		String arcurl = gameBean.getArcurl();
