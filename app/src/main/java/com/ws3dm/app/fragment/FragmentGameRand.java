...
public class FragmentGameRand extends BaseFragment {
...
//				GlideUtil.loadRoundImage(mContext,game.getLitpic(),imageView,5);
				...
				holder.setText(R.id.tv_type, game.getType());
				holder.setText(R.id.txtTime, game.getPubdate_at() == 0 ? "未知" : TimeUtil.getFormatTimeSimple(game.getPubdate_at()));
				holder.setText(R.id.tv_renqi, game.getClick() + "");
...
//					bundle.putSerializable("game", finalGame);//数据太大，超出系统限制
	...
	public void obtainData() {
		...
		Call<GameDJRespBean> call = service.djrank(body);
