...
import com.ws3dm.app.databinding.AcGameNetrandBinding;
import com.ws3dm.app.fragment.FragmentGameNetRand;
...
public class GameNetRandActivity extends BaseActivity{

	private AcGameNetrandBinding mBinding;
	private List<String> tabs = new ArrayList<>();//tablayout的标签数组
	private List<Fragment> fragments = new ArrayList<>();
	private static TabAdapter mTabAdapter;

	private String title[] = {"总排行", "新游榜", "期待榜"};

	@Override
	protected void init() {
		mBinding = bindView(R.layout.ac_game_netrand);
	...
	private void initView() {
		...
		for (int i=1;i<4;i++){
			Fragment mFragmentNewsList = new FragmentGameNetRand();
