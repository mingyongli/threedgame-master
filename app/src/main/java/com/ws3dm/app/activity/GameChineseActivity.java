...
import com.ws3dm.app.databinding.AcGameChineseBinding;
 ...
 * Date : 2019/6/19 9:19
 **/
public class GameChineseActivity extends BaseActivity{

	private AcGameChineseBinding mBinding;
	...
	@Override
	protected void init() {
		mBinding = bindView(R.layout.ac_game_chinese);
...
//        mForumPresenter.getForumRank(obj.toString());
		...
		Call<GameDJRespBean> call = service.djhh(body);
