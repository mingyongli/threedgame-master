...
public class SteamPriceRankAdapter extends BaseRecyclerAdapter<SteamPriceRankBean.DataBean.ListBean> {
    public SteamPriceRankAdapter(Context ctx, int layoutId) {
        super(ctx, layoutId);
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    @Override
    public void bindData(RecyclerViewHolder holder, int position, SteamPriceRankBean.DataBean.ListBean item) {
