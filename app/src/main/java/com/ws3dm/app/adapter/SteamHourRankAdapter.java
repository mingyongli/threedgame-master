...
public class SteamHourRankAdapter extends BaseRecyclerAdapter<SteamHourRankBean.DataBean.ListBean> {


    public SteamHourRankAdapter(Context ctx, int layoutId) {
        super(ctx, layoutId);
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    @Override
    public void bindData(RecyclerViewHolder holder, int position, SteamHourRankBean.DataBean.ListBean item) {
        ...
        price.setText(item.getGamehour() + "");
