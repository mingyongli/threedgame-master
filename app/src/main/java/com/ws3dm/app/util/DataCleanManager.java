...
//				+ "TB";
	...
	public static String getCacheSize(File inFile, File outFile) throws Exception {
		long a = getFolderSize(inFile);
		long b = getFolderSize(outFile);
		return getFormatSize(a+b);
	}
