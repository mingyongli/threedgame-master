...
//					downUrl="https://mytest.3dmgame.com/app/apptest";
                    ...
                    //File pathdir = new File(Environment.getExternalStoragePublicDirectory(DIRECTORY_DOWNLOADS).getPath());
                    File pathdir = new File(String.valueOf(context.getExternalFilesDir(DIRECTORY_DOWNLOADS)));
...
//				notificationManager.notify(2, builderProgress.build());
                ...
                case DOWNLOAD_FINISH:
                    // 安装文件
//				installAPK();
                    AppUtil.installApp(context, context.getExternalFilesDir(DIRECTORY_DOWNLOADS) + "/3dm.apk");
                    break;
                default:
                    break;
            }
