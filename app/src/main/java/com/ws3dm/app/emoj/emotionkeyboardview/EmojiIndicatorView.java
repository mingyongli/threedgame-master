package com.ws3dm.app.emoj.emotionkeyboardview;
...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public EmojiIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext=context;
        pointSize= ScreenUtil.dp2px(context,size);
        marginLeft=ScreenUtil.dp2px(context,marginSize);
    }
    ...
    public void playByStartPointToNext(int startPosition,int nextPosition){
        ...
        ViewNext.setBackgroundResource(R.drawable.red_point);
        ViewStrat.setBackgroundResource(R.drawable.white_point);
    }
