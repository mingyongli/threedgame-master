...
import com.ws3dm.app.emoj.adapter.EmotionGridViewAdapter;
import com.ws3dm.app.emoj.adapter.EmotionPagerAdapter;
import com.ws3dm.app.emoj.emotionkeyboardview.EmojiIndicatorView;
 ...
 */
public class EmotiomComplateFragment extends EmojBaseFragment {
    ...
    private void initEmotion() {
        ...
        // item的间距
        int spacing = ScreenUtil.dp2px(getActivity(), 12);
        // 动态计算item的宽度和高度
