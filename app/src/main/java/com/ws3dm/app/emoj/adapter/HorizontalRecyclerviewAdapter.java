package com.ws3dm.app.emoj.adapter;
...
public class HorizontalRecyclerviewAdapter extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(model.isSelected){
            holder.imageBtn.setBackgroundColor(context.getResources().getColor(R.color.grey));
        }else {
            holder.imageBtn.setBackgroundColor(context.getResources().getColor(R.color.grey_bg));
        }
