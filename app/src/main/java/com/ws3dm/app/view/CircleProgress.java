...
public class CircleProgress extends View {
    ...
    private int animDuration = CircleConstant.DEFAULT_ANIM_DURATION;
    ...
    public CircleProgress(Context context, AttributeSet attrs) {
        ...
        roundColor = typedArray.getColor(R.styleable.CircleProgress_roundColor, CircleConstant.DEFAULT_ROUND_COLOR);
        roundProgressColor = typedArray.getColor(R.styleable.CircleProgress_roundProgressColor, CircleConstant.DEFAULT_ROUND_PROGRESS_COLOR);
        circleStrokeWidth = (int) typedArray.getDimension(R.styleable.CircleProgress_circleStrokeWidth, CircleConstant.DEFAULT_CIRCLE_STROKE_WIDTH);
        valueText = typedArray.getString(R.styleable.CircleProgress_valueText);
        valueTextColor = typedArray.getColor(R.styleable.CircleProgress_valueTextColor, CircleConstant.DEFAULT_VALUE_TEXT_COLOR);
        valueTextSize = (int) typedArray.getDimension(R.styleable.CircleProgress_valueTextSize, CircleConstant.DEFAULT_VALUE_TEXT_SIZE);
        despText = typedArray.getString(R.styleable.CircleProgress_despText);
        if (valueText == null || despText == null) {
            valueText = CircleConstant.DEFAULT_VALUE_TEXT;
            despText = CircleConstant.DEFAULT_DESP_TEXT;
        }
        despTextColor = typedArray.getColor(R.styleable.CircleProgress_despTextColor, CircleConstant.DEFAULT_DESP_TEXT_COLOR);
        despTextSize = (int) typedArray.getDimension(R.styleable.CircleProgress_despTextSize, CircleConstant.DEFAULT_DESP_TEXT_SIZE);
        valueTextIsDisplayable = typedArray.getBoolean(R.styleable.CircleProgress_valueTextIsDisplayable, CircleConstant.DEFAULT_VALUE_TEXT_IS_DISPLAYABLE);
        despTextIsDisplayable = typedArray.getBoolean(R.styleable.CircleProgress_despTextIsDisplayable, CircleConstant.DEFAULT_DESP_TEXT_IS_DISPLAYABLE);
        circleStyle = typedArray.getInt(R.styleable.CircleProgress_style, CircleConstant.STYLE_STROKE);
        typedArray.recycle();
    ...
    private void init() {
        ...
        //设置空心或实心
        if (circleStyle == CircleConstant.STYLE_STROKE) {
...
//        despText = CircleConstant.DEFAULT_DESP_TEXT;
    ...
    public void anim() {
        ...
        mValueAnimator.setDuration(CircleConstant.DEFAULT_ANIM_DURATION);
