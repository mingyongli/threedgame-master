package com.ws3dm.app.view.dialog;
...
public class WheelMain {
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m) {
		...
		// 年
		wv_year = (WheelViewTime) view.findViewById(R.id.year);
		...
		// 月
		wv_month = (WheelViewTime) view.findViewById(R.id.month);
		...
		// 日
		wv_day = (WheelViewTime) view.findViewById(R.id.day);
		...
		wv_hours = (WheelViewTime) view.findViewById(R.id.hour);
		wv_mins = (WheelViewTime) view.findViewById(R.id.min);
		if (hasSelectTime) {
		...
		int textSize = 0;
		if (hasSelectTime)
			textSize = (screenheight / 135) * 3;
		else
			textSize = (screenheight / 135) * 4;
