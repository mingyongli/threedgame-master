...
package com.ws3dm.app.view.roundimage;
 ...
 * 
 ...
 />
 * 
 * 1.mMutateBackground属性，实现background是否也可以有圆角效果
 * 2.riv_tile_mode 有三种clamp，repeat，mirror，分别是
 * 指缩放、重复、镜像，实现后两种的效果，最后是src的分辨率小于RoundedImageView的分辨率才比较直观显示
 **/
